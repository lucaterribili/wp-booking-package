...
function Booking_manage(schedule_data, booking_package_dictionary, webApp) {
    ...
    this.getCookie = function(c_name){
        ...
        if(document.cookie.length > 0){
            ...
            if(st != -1){
                ...
                let value = unescape(document.cookie.substring(st, ed));
    ...
    this.selectCalendarAccount = function(calendarData, month, day, year, selectCalendarAccountPanel, calendarAccountList, accountKey){
        ...
        defaultOption.text = "Seleziona un calendario"; // Testo del placeholder
        defaultOption.value = 0; // Valore del placeholder, se necessario
        console.log('devi guardare qui', accountKey);
        select.appendChild(defaultOption);
        for (let i = 0; i < calendarAccountList.length; i++) {

            let calendarAccount = calendarAccountList[i];
    ...
    this.createCalendar = function(calendarData, month, day, year, accountKey) {
        ...
        let selectCalendarAccountPanel = document.createElement("div");
        let calendarAccount = calendarData.account;
        object._console.log(calendarAccount);
        ...
        let dayHeight = parseInt(calendarPanel.clientWidth / 7);

        let weekName = [object._i18n.get('Sun'), object._i18n.get('Mon'), object._i18n.get('Tue'), object._i18n.get('Wed'), object._i18n.get('Thu'), object._i18n.get('Fri'), object._i18n.get('Sat')];
        ...
        let returnPanel = document.createElement("div");
