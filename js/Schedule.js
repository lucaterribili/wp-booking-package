...
function SCHEDULE(schedule_data, booking_package_dictionary, webApp) {
    ...
    this.getCalendarAccountListData = function (month, day, year) {
        ...
        var post = {
            ...
            mode: 'getCalendarAccountListData',
            year: year,
            month: month,
            day: day
        };
    ...
    this.createCalendarAccountList = function (accountList, month, day, year) {
        ...
        var list = {
            key: 'ID',
            name: object._i18n.get('Name'),
            status: object._i18n.get('Status'),
            type: object._i18n.get('Type'),
            shortCode: object._i18n.get('Shortcode')
        };
    ...
    this.loadTabFrame = function (accountList, month, day, year, account) {
        ...
        var menuList = {
            ...
            subscriptionsLink: 'subscriptionsPanel',
    ...
    this.createCalendar = function (calendarData, month, day, year, account) {
        ...
        if (document.getElementById("save_setting") == null) {
            ...
            deletePublishedScheduleButton.onclick = function () {
                ...
                var date_list = {
                    deletePublishedSchedules_from_month: "n",
                    deletePublishedSchedules_from_day: "j",
                    deletePublishedSchedules_from_year: "Y",
                    deletePublishedSchedules_to_month: "n",
                    deletePublishedSchedules_to_day: "j",
                    deletePublishedSchedules_to_year: "Y"
                };
            ...
            if (document.getElementById("edit_schedule_button") == null) {
                ...
                editButton.onclick = function () {
                    ...
                    var post = {
                        nonce: object.nonce,
                        action: object.action,
                        mode: 'getRangeOfSchedule',
                        accountKey: account.key,
                        year: year,
                        month: month,
                        start: scopeOfDay.start,
                        end: scopeOfDay.end
                    };
    ...
    this.getPublicSchedule = function (month, day, year, account, hasIncompletelySchedules, callback) {
        ...
        deleteSchedulesButton.onclick = function (event) {
            ...
            var post = {
                nonce: object.nonce,
                action: object.action,
                mode: "deletePerfectPublicSchedule",
                month: month,
                day: day,
                year: year,
                accountKey: account.key
    ...
    this.createSchedulePanel = function (weekKey, scheduleData, mode) {
            ...
            document.getElementById("readSchedulesButton").onclick = function () {
                ...
                for (var time = (parseInt(from) * 60) + parseInt(fromMinutes); time <= (parseInt(to) * 60) + parseInt(toMinutes); time += parseInt(interval)) {
                    ...
                    readList.push({
                        ...
                        min: time % 60,
                        deadline: load_deadline_time,
                        capacities: load_capacity,
                        remainders: load_capacity
                    });
        ...
        for (var i = 0; i < 300; i++) {
            ...
            var schedule_data = {
                ...
                stop: checkBox,
                delete: deletekBox,
                deadlineTime: deadlineTimeBlock
            };
    ...
    this.syncPanel = function (ical, syncPastCustomersForIcal, icalToken, home, account, callback) {
        ...
        var active = {
            ...
            inputLimit: 1,
            inputType: 'RADIO',
            valueList: {1: object._i18n.get("Enabled"), 0: object._i18n.get("Disabled")}
        };
        ...
        var syncPastCustomersForIcalValue = {
            name: 'Active', value: parseInt(syncPastCustomersForIcal), inputLimit: 1, inputType: 'SELECT', valueList:
                {
    ...
    this.settingPanel = function (accountList, month, day, year, account, callback) {
        ...
        if (account.enableFixCalendar != null && account.monthForFixCalendar != null && account.yearForFixCalendar) {
            ...
            account.fixCalendar = {
                enableFixCalendar: account.enableFixCalendar,
                monthForFixCalendar: account.monthForFixCalendar,
                yearForFixCalendar: account.yearForFixCalendar
            };
        ...
        saveButton.onclick = function () {
            ...
            var post = {
                nonce: object.nonce,
                action: object.action,
                mode: 'updateCalendarAccount',
                accountKey: account.key,
                remakeBookingSchedules: 0
            };
        ...
        for (var id in mail_message) {
            ...
            tr.onclick = function () {
                ...
                if (account.type == 'hotel') {
                    ...
                    shortcodes = {
                        id: object._i18n.get("ID"),
                        bookingDetails: object._i18n.get("Booking details"),
                        checkIn: object._i18n.get("Arrival (Check-in)"),
                        checkOut: object._i18n.get("Departure (Check-out)"),
                        guests: object._i18n.get("Guests"),
                        service: object._i18n.get("Service"),
                        paymentMethod: object._i18n.get('Payment method')
                    };
                ...
                mail_message_save_button.onclick = function () {
                    ...
                    object.loadingPanel.setAttribute("class", "loading_modal_backdrop");
                    var post = {
                        mode: "updataEmailMessageForCalendarAccount",
                        nonce: object.nonce,
                        action: object.action,
                        mail_id: mailMessageData.key,
                        subject: subject_filed.value,
                        content: value,
                        subjectForAdmin: subject_filed_for_admin.value,
                        contentForAdmin: valueForAdmin,
